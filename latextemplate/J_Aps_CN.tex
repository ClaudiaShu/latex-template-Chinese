...
\newcommand{\pubyear}{2019}      % 出版年份
\newcommand{\enpubyear}{2019}    % 出版年份
\newcommand{\pubmonth}{xx}       % 出版月份
\newcommand{\enpubmonth}{xx}     % 出版月份


\newcommand{\modifydate}{2019年XX月XX日完成}% 论文完成日期

%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%-------------------- 作者提供的信息 ------------------------%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\runcnauthors}{作者姓名}
\newcommand{\cnfirstauthor}{作者姓名}
\newcommand{\cnfirstinst}{班级: XXXX, 学号: XXXXXXXXXXXXX}
...
\newcommand{\enfirstinst}{Class: XXXX, student ID: XXXXXXXXXXXXX}
...
\newcommand{\fundinfo}{多媒体技术 2019.}
\newcommand{\authorsinfo}{\textbf{作者信息}:~
作者姓名, 班级: XXXX, 学号: XXXXXXXXXXXXX, ~E-mail:xxxxx@xxxx.xxx.xx~}
...
\end{minipage}
\end{center}
\footnote[0]{\scriptsize{\modifydate.\\
...
\item 数学中的空心大写字体通常使用\verb|\mathbb{}|命令, 字体美观, 但对数字失效, 一种方案是使用宏包psfont的命令\verb|\mathds{}|或重新定义的命令\verb|\mathbbold{}|,
    例如\verb|$\mathbb{A,B,R}, \mathbold{ABCP1}$|产生$\mathbb{A,B,R}$, $\mathbbold{ABCP1}$.
